...
export const RPC_URL =
  'https://solana--mainnet.datahub.figment.io/apikey/1439fe679592c7006d0698182ed300fe/';
export const MANGO_PROGRAM_KEY = new PublicKey(
  'mv3ekLzLbnVPNxjSKvqBpU3ZeZXPQdEC3bp5MDEBG68'
);
export const MANGO_GROUP_CONFIG_KEY = new PublicKey(
  '98pjRuQjK3qA6gXts96PqZT4Ze5QmnCmt3QYjhbUSPue'
);
export const USDC_MINT_KEY = new PublicKey(
  'EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v'
);
export const DRIFT_PROGRAM_KEY = new PublicKey(
  'dammHkt7jmytvbS3nHTxQNEcP59aE57nxwV21YdqEDN'
);
export const DRIFT_STATE_KEY = new PublicKey(
  'FExhvPycCCwYnZGeDsVtLhpEQ3yEkVY2k1HuPyfLj91L'
);
export const BUTLER_PROGRAM_KEY = new PublicKey(
  '86pSXTcTkDSr7QkaRyfyS6K9n5ZVw1cz1unS3o9tbYEX'
);
export const MANGO_USDC_ROOT_KEY = new PublicKey(
  'AMzanZxMirPCgGcBoH9kw4Jzi9LFMomyUCXbpzDeL2T8'
);
export const MANGO_USDC_NODE_KEY = new PublicKey(
  'BGcwkj1WudQwUUjFk78hAjwd1uAm8trh1N4CJSa51euh'
);
export const MANGO_CACHE_KEY = new PublicKey(
  'EBDRoayCDDUvDgCimta45ajQeXbexv7aKqJubruqpyvu'
);
export const MANGO_USDC_VAULT = new PublicKey(
  '8Vw25ZackDzaJzzBBqcgcpDsCsDfRSkMGgwFQ3gbReWF'
);
export const MANGO_SIGNER_KEY = new PublicKey(
...
export const MANGO_DRFIT_CONFIG = {
  'SOL-PERP': {
    ...
    mangoPerpMarketKey: new PublicKey(
  ...
  'BTC-PERP': {
    ...
    mangoPerpMarketKey: new PublicKey(
      'DtEcjPLyD4YtTBB4q8xwFZ9q49W89xZCZtJyrGebi5t8'
    ),
  ...
  'AVAX-PERP': {
    ...
    mangoPerpMarketKey: new PublicKey(
      'EAC7jtzsoQwCbXj1M3DapWrNLnc3MBwXAarvWDPr2ZV9'
    ),
  ...
  'LUNA-PERP': {
    ...
    mangoPerpMarketKey: new PublicKey(
      'BCJrpvsB2BJtqiDgKVC4N6gyX1y24Jz96C6wMraYmXss'
    ),
  ...
  'ETH-PERP': {
    ...
    mangoPerpMarketKey: new PublicKey(
      'DVXWg6mfwFvHQbGyaHke4h3LE9pSkgbooDSDgA4JBC8d'
    ),
...
export const WHITELIST_PUBKEY = [
  ...
  '2sWd91VB5JUqsBtx7dd6Vw4D8jiEAcG27H8iRuGTYYQL', /// gm
];

...
export const AppBar: FC = (props) => {
  ...
  let ddLink =
    'https://p.datadoghq.com/sb/1e87a1b8-5085-11ec-a6b0-da7ad0900002-70b44d89dce3a234ead0846e06e707aa';
  if (publicKey) {
    ddLink = `https://p.datadoghq.com/sb/1e87a1b8-5085-11ec-a6b0-da7ad0900002-70b44d89dce3a234ead0846e06e707aa?tpl_var_user=${publicKey
      .toString()
      .toLowerCase()}&live=true`;
  }
      ...
      <div className="mb-2 shadow-lg navbar bg-neutral text-neutral-content">
        ...
        <div className="lg:flex navbar-center">
          <div className="flex items-stretch">
            ...
            <Link href="/configs">
              <div className="btn btn-ghost btn-sm rounded-btn">Configs</div>
            </Link>
            <a href={ddLink} target="_blank" rel="noreferrer">
              <div className="btn btn-ghost btn-sm rounded-btn">Dashboard</div>
            </a>
          </div>
        </div>

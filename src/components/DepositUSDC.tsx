...
export const DepositUSDC: FC<DepositUSDCProps> = (props) => {
    ...
    return (
        <div>
            {<a href={`https://app.drift.trade/AVAX?authority=${props.butlerAccountOwner.toString()}`}> <button className="btn m-2 bg-gradient-to-r from-[#9945FF] to-[#14F195] hover:from-pink-500 hover:to-yellow-500 ..."> Drift Account </button></a>}
            {<a href={`https://trade.mango.markets/account?pubkey=${props.mangoAccount.toString()}`}><button className="btn m-2 bg-gradient-to-r from-[#9945FF] to-[#14F195] hover:from-pink-500 hover:to-yellow-500 ..."> Mango Account </button></a>}
